...
controller('newFileModalController', ['$scope', '$modalInstance', '$timeout', 'newFileService', '$state',
  function($scope, $modalInstance, $timeout, newFileService, $state) {
    var initialize = function() {
      ...
      newFileService.getApiMethodList().then(function(data) {
    ...
    $scope.create = function() {
      ...
      if ($scope.newApiForm.$valid) {
        newFileService.createApi($scope.newApiObj).then(function(res) {
